...
const mockTables: TableData[] = Array.from({ length: 20 }, (_, i) => ({
  ...
  tags: [
    ...(Math.random() > 0.7 ? ['pipeline-failed'] : []),
...
export const PipeLineTablesView: React.FC = () => {
  ...
  const tagCounts = {
    'pipeline-failed': mockTables.filter(t => t.tags.includes('pipeline-failed')).length,
    ...
    <div className="p-4">
      ...
      <div className="mb-6 grid grid-cols-2 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <div className="text-2xl font-semibold">94,42,536 </div>
          </div>
        </div>
                                  ...
                                  {table.tags.map(tag => (
                                    <span
                                      ...
                                      className={`
                                        ...
                                        ${tag === 'pipeline-failed' ? 'bg-red-100 text-red-800' : ''}
