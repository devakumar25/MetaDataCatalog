...
export const TablesView: React.FC = () => {
  ...
  //  { key: 'dataSource', label: 'Data Source', visible: true, sortable: true },
    { key: 'rowCount', label: 'Row Count', visible: true, sortable: true },
    { key: 'mainEngineSync', label: 'Storage Engine', visible: true, sortable: true },
    ...
    <div className="p-4">
      ...
      <div className="mb-6 grid grid-cols-2 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <div className="text-2xl font-semibold">1,13,42,536</div>
          </div>
        </div>
                        ...
                        return (
                          <td key={column.key} className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div className="flex items-center justify-end space-x-2">
                              <button
                                onClick={() => handleShowLineage(table.name)}
