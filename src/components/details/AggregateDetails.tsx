...
export const AggregateDetails: React.FC<AggregateDetailsProps> = ({ 
  asset, 
  onClose,
  path = [],
  onPathChange
  ...
  // Only show Multi Table tag for Aggregate Formulas
  const showMultiTableTag = asset.type === 'Aggregate Formulas' && asset.tags.includes('multi-table');
