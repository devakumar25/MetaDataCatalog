...
import { Overview } from './sections/column/Overview';
import { ColumnQuality } from './sections/column/ColumnQuality';
...
export const ColumnDetails: React.FC<ColumnDetailsProps> = ({ 
  ...
  const tabs = [
    ...
    { id: 'quality', label: 'Column Quality', icon: Icons.LineChart },
      ...
      <div className="bg-gray-50 rounded-lg w-[90vw] h-[90vh] flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200 flex items-center justify-between bg-white">
          <div className="flex items-center space-x-3">
            <div className="p-2 bg-blue-50 rounded-lg">
              <Icons.GitBranch className="w-6 h-6 text-blue-600" />
            </div>
            <div>
        ...
        <div className="flex-1 p-4 overflow-y-auto">
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            ...
            {activeTab === 'quality' && <ColumnQuality asset={asset} />}
            {activeTab === 'lookups' && <Lookups lookups={[]} />}
            {activeTab === 'assets' && (
              <Assets 
                path={path}
