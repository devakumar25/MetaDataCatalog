...
import { Overview } from './sections/report/Overview';
import { InvolvedColumns } from './sections/report/InvolvedColumns';
import { Formatting } from './sections/report/Formatting';
...
export const ReportDetails: React.FC<ReportDetailsProps> = ({ 
  ...
  const tabs = [
    ...
    { id: 'formatting', label: 'Formatting', icon: Icons.Palette },
    { id: 'columns', label: 'Involved Columns', icon: Icons.Columns },
  ...
  const stats = [
    { label: 'Dimensions', count: 8, icon: Icons.Box },
    { label: 'Aggregates', count: 12, icon: Icons.Calculator },
    { label: 'Filters', count: 5, icon: Icons.Filter },
  ];
      ...
      <div className="bg-gray-50 rounded-lg w-[90vw] h-[90vh] flex flex-col">
        ...
        <div className="flex-1 p-4 overflow-y-auto">
          <div className="bg-white p-4 rounded-lg border border-gray-200">
            ...
            {activeTab === 'formatting' && <Formatting asset={asset} />}
            {activeTab === 'columns' && <InvolvedColumns />}
            {activeTab === 'assets' && (
              <Assets 
                path={path}
