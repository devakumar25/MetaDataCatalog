...
import { InvolvedViews } from './sections/dashboard/InvolvedViews';
...
export const DashboardDetails: React.FC<DashboardDetailsProps> = ({ 
  ...
  const tabs = [
    ...
    { id: 'views', label: 'Involved Views', icon: Icons.Columns },
  ...
  const stats = [
    { label: 'Views', count: 8, icon: Icons.LayoutDashboard },
    { label: 'Data Sources', count: 3, icon: Icons.Database },
