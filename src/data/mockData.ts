...
import { DataSource, RecommendedAction } from '../types/assets';
...
export const getMockDataSource = (id: string): DataSource => ({
  id,
  name: 'Salesforce',
  type: 'PostgreSQL',
  status: 'active',
...
export const getMockRecommendedActions = (): RecommendedAction[] => [
  {
    id: '1',
    type: 'warning',
